export class ConfigParseError extends Error {
    configPath;
    format;
    constructor(configPath, format, cause) {
...
export function describeParseFailure(error, fallbackPath, fallbackFormat = "配置") {
...
export function buildParseFailureFinding(options) {
    ...
    return {
        ...
        description: `无法安全完成 ${options.displayName} 的配置检查；原因：${failure.reason}。` +
