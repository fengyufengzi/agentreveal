...
export const PROXY_MANAGED_AUTH_LABEL = "PROXY_MANAGED（CC Switch 鉴权占位符）";
export function isProxyManagedPlaceholder(value) {
    return (typeof value === "string" &&
        value.trim() === PROXY_MANAGED_PLACEHOLDER);
}
export function ccSwitchAppLabel(appType) {
...
//# sourceMappingURL=proxy-managed.js.map